...
{\centering \includegraphics{index_files/figure-pdf/results-histogram-1.pdf}
...
Among parcels affected by the bill, we find that the area-weighted mean
effect would be an additional 1.35 FAR allowed:
...
\caption{Increase in Maximum FAR for Parcels Affected by HB 2160}
