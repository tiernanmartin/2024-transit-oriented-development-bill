...
We examine the station areas of several cities to assess how the effects of HB 2160 may differ from place to place.

```{r}
#| label: results-case-studies-comparison-table
#| tbl-cap: "Tbale 2:Case Studies Comparison"

col_names_city <- c("City", "Parcels (n)", " Land Area (sq. miles)")
...
p_tbl_summary_city |> 
  kable(col.names = col_names_city) 
