...
HB 2160 defines floor area ratio (FAR) as "a measure of development intensity equal to building square footage divided by the developable property square footage".[@reed2024] The metric combines two commonly-used regulatory tools (maximum building height and maximum lot coverage) into a single ratio, providing developers with design flexibility while allowing local government to set a maximum amount of development intensity within a zoning district. See @fig-far for an illustration of FAR's flexibility.

![Illustrations of FAR Limits \| Source: *Accessory Dwelling Unit Final EIS*, City of Seattle, 2018](images/seattle-far-diagram.png){#fig-far style="float: left; margin-right: 20px; margin-bottom: 20px;" fig-alt="A diagram showing different ways that a development could arrange 1.0 FAR on a lot: 1 story, 2 stories, 3 stories" fig-align="left" width="600"}
...
Our study focuses on the third analysis group, *Developable, Affected*, which are the majority of the station area parcels by both count (78%) and land area (64%). We find that the total amount of additional development capacity that would be added by HB 2160 to be approximately 3.6 billion ft^2^.[^10]
...
HB 2160 would affect several station areas within Shoreline's city boundary, including two light rail stations and approximately 30 bus rapid transit stations.[^12]
...
House Bill 2160 aims to significantly increase development capacity near transit stops in the Puget Sound region, marking a meaninful move towards transit-oriented development. While this study indicates a substantial potential for new development capacity, it's important to consider these figures as estimates due to data and methodological limitations. Future refinements in data and methodology could enhance certainty about the bill's capacity impact. Despite these limitations, the bill is projected to have a considerable effect on the region's housing production, vehicle miles traveled, and development landscape.
