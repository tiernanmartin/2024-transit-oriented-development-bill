...
p_addtl_max <- max(p$zoning_new_max_far_additional, na.rm = TRUE)

n_parcels <- scales::comma(nrow(filter(p, zoning_new_max_far_additional > 0)))

subtitle <- TeX("Area-weighted mean net development capacity ($AWM_{NDC}$) is 1.35 FAR, n = 97,434 parcels (78%)")
