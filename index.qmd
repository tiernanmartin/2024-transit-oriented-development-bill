...
House Bill 2160 (2023-2024 Washington State Legislative Session) proposed changes to the GMA intended to promote community and transit-oriented housing development.[^4] These changes, which would apply to all cities planning under the GMA, included the following:

[^4]: This study used the Second Substitute of House Bill 2160 as the basis for its analysis.
...
-   Does not account for other restrictions on development, such as critical areas, shoreline environments, landmark designation
