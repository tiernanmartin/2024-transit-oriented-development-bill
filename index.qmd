...
[^8]: See @ref(appendix-case-studies-kent-stations-table) for a complete list of the station areas.
...
```{r}
#| label: results-case-studies-kent-maps
#| eval: true
#| message: false
...
```{r}
#| label: appendix-case-studies-kent-stations-table
#| 
