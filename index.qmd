...
HB 2160 would affect several station areas within Kent's city boundary, including two light rail stations, one commuter rail station, and 15 bus rapid transit stations.See Table @ref(\@tbl-appendix-case-studies-kent-stations-table) in the appendix for a complete list of the station areas in Kent.

We find the area-weighted mean net development capacity ($AWM_{NDC}$) for Kent's station areas to be 2.07 FAR.
...
ggplot(diamonds, aes(carat)) +
  geom_histogram()
# kent_hist_subtitle <- TeX("$AWM_{NDC}$ is 2.07 FAR, n = 1,195 (69%)")
# 
# p_affected_kent |>
# ggplot() +  
...
Map of parcels within Kent's station areas:
